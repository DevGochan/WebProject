        ...
        <div class="container px-lg-5">
            <div class="p-4 p-lg-5 bg-white rounded-3 text-center">
                <div class="m-4 m-lg-5">
                    <h1 class="display-5 fw-bold">Take a look at the representative dishes of each country and their charms!</h1>
                    <p class="fs-4"><br></p>
        ...
        <div class="container px-lg-5">
            ...
            <div class="row gx-lg-5">
                <div class="col-lg-6 col-xxl-4 mb-5">
                    <div class="card bg-white border-0 h-100">
                        <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            <a href="food_italy.php" style="text-decoration: none;">
                                <img src="images/italy/italy.png">
                                <h2 class="fs-4 fw-bold"><br>Italy</h2>
                                <p class="mb-0">Italian cuisine is renowned for its rich flavors and diverse ingredients.</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xxl-4 mb-5">
                    <div class="card bg-white border-0 h-100">
                        <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            <a href="food_czech.php" style="text-decoration: none;">
                                <img src="images/czech/czech.png">
                                <h2 class="fs-4 fw-bold"><br>Czech</h2>
                                <p class="mb-0">Czech cuisine offers hearty dishes with influences from Central European traditions.</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xxl-4 mb-5">
                    <div class="card bg-white border-0 h-100">
                        <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            <a href="food_france.php" style="text-decoration: none;">
                                <img src="images\france\france.png">
                                <h2 class="fs-4 fw-bold"><br>France</h2>
                                <p class="mb-0">French cuisine is renowned for its exquisite flavors, delicate techniques, and sophisticated presentation.</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xxl-4 mb-5">
                    <div class="card bg-white border-0 h-100">
                        <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            <a href="food_switzerland.php" style="text-decoration: none;">
                                <img src="images\switzerland\switzerland.png">
                                <h2 class="fs-4 fw-bold"><br>Switzerland</h2>
                                <p class="mb-0">Swiss cuisine: a fusion of cheese, alpine flavors, and traditional dishes.</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xxl-4 mb-5">
                    <div class="card bg-white border-0 h-100">
                        <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            <a href="food_hungary.php" style="text-decoration: none;">
                                <img src="images\hungary\hungary.png">
                                <h2 class="fs-4 fw-bold"><br>Hungary</h2>
                                <p class="mb-0">Hungarian cuisine: bold flavors, hearty meats, indulgent desserts.</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xxl-4 mb-5">
                    <div class="card bg-white border-0 h-100">
                        <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            <a href="food_austria.php" style="text-decoration: none;">
                                <img src="images\austria\austria.png">
                                <h2 class="fs-4 fw-bold"><br>Austria</h2>
                                <p class="mb-0">Austrian food is the unique cuisine of Austria, located in Central Europe, and reflects its culture and history.</p>
                            </a>
                        </div>
                    </div>
                </div>
